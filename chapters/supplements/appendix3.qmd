...
**Pilot.** The EFA yielded five factors based on parallel analysis (see Table A2.1).
...
We plotted the factor loadings of each factor in the Pilot against those in Study 1 to investigate their correspondence (See Figure A2.1).
...
#| fig.height: 7
#| fig-cap: | 
#|   **Figure A2.1.** Comparison of factor loadings of unpredictability items in the Pilot and Study 1. 
study1_efa_fig 
```

### Bivariate correlations between future orientation and impulsivity with attention tasks 

Table A2.2 shows bivariate correlations between self-reported depression, impulsivity, future orientation, and SES with each of the Flanker SSP parameters and the Global-Local drift rate difference.
...
Specifically, boundary separation estimates for several participants ended up at an upper boundary of 10, indicating that they were not recovered well (see Figure A2.2).
...
This improved parameter estimation (see Figure A2.4).
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.2.** Distributions of Drift Diffusion Model parameters for the Cued Attention Task using Maximum likelihood estimation.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.3.** Distributions of Drift Diffusion Model parameters for the Cued Attention Task using Kolmogorov-Smirnov estimation.
...
Model convergence was assessed (1) by visually inspecting the traces, which should not contain any drifts or large jumps (see Figure A2.4 and Figure A2.7); (2) through simulation. Specifically, we used each participant's DDM estimates to simulate 100 RT and accuracy estimates (per condition). The distributions of the participant's true RTs and their simulated RTs were assessed through bivariate correlations at the 25th, 50th and 75th percentile (See Figure A2.5 and Figure A2.8).
We made the same comparison for mean accuracy levels (See Figure A2.6 and Figure A2.9).
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.4. ** Chain convergence for the Hierarchical Bayesion Drift Diffusion Model for the Cued Attention Task. Plots should resemble a 'fat, hairy catterpillar'.
pilot_traces_cueing
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.5.** Drift Diffusion parameter recovery for the Cued Attention Task comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.6.** Drift Diffusion parameter recovery for the Cued Attention Task comparing simulated and recovered accuracy rates.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.7.** Chain convergence for the Hierarchical Bayesion Drift Diffusion Model for the Change Detection Task. Plots should resemble a 'fat, hairy catterpillar'.
pilot_traces_change
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.8.** Drift Diffusion parameter recovery for the Change Detection Task comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.9.** Drift Diffusion parameter recovery for the Change Detection Task comparing simulated and recovered accuracy rates.
...
As can be seen in Figure A2.10 and Figure A2.11, we observed high agreement between observed and simulated RTs and accuracy rates.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.10.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.11.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates.
...
Figure A2.12 and Figure A2.13 show the model fit based on simulated data.
...
#| fig.height: 7
#| fig-cap: | 
#|   **Figure A2.12.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times across the standard, enhanced, and degraded condition.
study1_ssp_fit_rt
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.13.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates across the standard, enhanced, and degraded condition.
study1_ssp_fit_acc
```
...
Figure A2.14 and Figure A2.15 show the model fit based on simulated data.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.14.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
study2_ssp_fit_rt
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure A2.15.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates.
study2_ssp_fit_acc
```
...
Figure A2.16 provides an overview of these correlations for attentional width, shrinking rate, interference, and, for illustrative purposes, the RT difference score.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.16. **Within-person bivarate correlations between Flanker conditions in Study 2 for RT differences, attentional width, shrinking rate, and interference.
study1_ssp_cor_plot
```
...
Figure A2.17 and Figure A2.18 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 3 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.18.** Multiverse explained variance of each data cleaning decision belonging to the analyses reported in Table 3 in the main text. Panel A: Cued Attention Task. Panel B: Change Detection Task. Panel C: Flanker Task.
final_plot_S18 <- 
...
Figure A2.19 and Figure A2.20 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 4 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.20.** Multiverse explained variance of each data cleaning decision belonging to the analyses reported in Table 4 in the main text. Panel A: Analyses involving violence exposure (hypothesis-driven). Panel B: Analyses involving unpredictability (exploratory).
final_plot_S20 <- 
...
Figures A2.21-S24 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 5 in the main text.
...
#| include: false
#| echo: false
f24_p1 <- study1_expl_ssp_enh_variance_plot$rt_diff + labs(title = "RT difference", tag = "A", y = "", fill = "") + theme_classic() 
f24_p2 <- study1_expl_ssp_enh_variance_plot$p_flanker + labs(title = "Perceptual input", y = "") + guides(fill = "none") + theme_classic()
f24_p3 <- study1_expl_ssp_enh_variance_plot$interference_flanker + labs(title = "Interference", y = "") + guides(fill = "none") + theme_classic()
f24_p4 <- study1_expl_ssp_enh_variance_plot$a_flanker + labs(title = "Boundary separation", y = "") + guides(fill = "none") + theme_classic()
f24_p5 <- study1_expl_ssp_enh_variance_plot$t0_flanker + labs(title = "Non-decision time", y = "") + guides(fill = "none") + theme_classic()

f24_p6 <- study1_expl_ssp_deg_variance_plot$rt_diff + labs(title = "RT difference", tag = "B", y = "") + guides(fill = "none") + theme_classic() 
f24_p7 <- study1_expl_ssp_deg_variance_plot$p_flanker + labs(title = "Perceptual input", y = "") + guides(fill = "none") + theme_classic()
f24_p8 <- study1_expl_ssp_deg_variance_plot$interference_flanker + labs(title = "Interference", y = "") + guides(fill = "none") + theme_classic() 
f24_p9 <- study1_expl_ssp_deg_variance_plot$a_flanker + labs(title = "Boundary separation", y = "") + guides(fill = "none") + theme_classic() 
f24_p10 <- study1_expl_ssp_deg_variance_plot$t0_flanker + labs(title = "Non-decision time", y = "") + guides(fill = "none") + theme_classic() 
...
Figure A2.25 and Figure A2.26 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Figure 2 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.25.** Multiverse p-value distributions belonging to the associations between violence exposure with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 2 in the main text. 
(
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.26.** Multiverse explained variance of each data cleaning decision belonging to the associations between violence exposure with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 2 in the main text. 
(
...
Figure A2.27 and Figure A2.28 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Figure 3 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.27.** Multiverse p-value distributions belonging to the associations between unpredictability with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 3 in the main text. 
(
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure A2.28.** Multiverse explained variance of each data cleaning decision belonging to the associations between unpredictability with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 3 in the main text. 
(
